...
-- 데일리 코멘트
DROP TABLE IF EXISTS "DailyComment";
...
COMMENT ON COLUMN "DailyComment"."id" IS 'autoincrement';
...
ALTER TABLE "DailyComment" ADD CONSTRAINT "PK_DAILYCOMMENT" PRIMARY KEY ("id");
...
ALTER TABLE "DailyComment" ADD CONSTRAINT "FK_User_TO_DailyComment_1" FOREIGN KEY ("userId")
REFERENCES "User" ("id")
ON DELETE CASCADE;
...
ALTER TABLE "DailyComment" ADD CONSTRAINT "UK_DAILYCOMMENT_USER_DATE" UNIQUE ("userId", "dailyDate");
...
CREATE TRIGGER update_dailyComment_modtime
    BEFORE UPDATE ON "DailyComment"
    FOR EACH ROW
    EXECUTE FUNCTION update_modified_column();